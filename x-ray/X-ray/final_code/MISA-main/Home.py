...
def load_cnn_model():
    model = tf.keras.models.load_model('C:/Users/myong/Desktop/x-ray/X-ray/훈련된 cnn 모델/my_trained_cnn_model.h5')  # Ensure the file is in the correct directory
    return model
...
# Streamlit UI
st.set_page_config(page_title="X-ray Pneumonia Detection", page_icon="🩻", initial_sidebar_state="expanded")
